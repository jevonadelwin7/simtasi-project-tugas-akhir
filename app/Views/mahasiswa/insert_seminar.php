                            ...
                            <form action="<?= base_url('mahasiswa/daftar'); ?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group" hidden>
                                        ...
                                        <input type="text" name="jenis" class="form-control bg-secondary text-center" value="proposal">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="card-footer text-center">
                                    <button type="submit" name="submit" value="insert" class="btn btn-block btn-success">Kumpulkan</button>
                                </div>
