                ...
                <div class="col-md-10 mx-auto">
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title">Request Bimbingan Proposal</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= base_url('mahasiswa/insert_request_proposal'); ?>" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul_proposal" class="form-control" placeholder="Isi Judul Proposal Anda">
                                </div>
                                <div class="form-group">
                                    <label for="inputDescription">Tentang Judul</label>
                                    <textarea name="tentang_judul" class="form-control" placeholder="Jelaskan secara singkat tentang penelitian Anda." rows="4"></textarea>
                                </div>
                                <div class="form-group">
